            ...
            <div className="dropdown-div">
                ...
                <div class="dropdown-buttons" style={this.state.isAlignment ? { display: "block" } : { display: "none" }}>
                    <span aria-label=" Left align" class="czi-tooltip-surface" data-tooltip=" Left align" role="tooltip">
                        <span aria-disabled="false" aria-pressed="false" className={this.state.value == 'left' ? 'czi-custom-button use-icon active' : 'czi-custom-button use-icon'} role="button" onClick={this.onButtonClick.bind(this, 'left')}>
                    ...
                    <span aria-label=" Center Align" class="czi-tooltip-surface" data-tooltip=" Center Align" role="tooltip">
                        <span aria-disabled="false" aria-pressed="false" className={this.state.value == 'center' ? 'czi-custom-button use-icon active' : 'czi-custom-button use-icon'} role="button" onClick={this.onButtonClick.bind(this, 'center')}>
                    ...
                    <span aria-label=" Right Align" class="czi-tooltip-surface" data-tooltip=" Right Align" role="tooltip">
                        <span aria-disabled="false" aria-pressed="false" className={this.state.value == 'right' ? 'czi-custom-button use-icon active' : 'czi-custom-button use-icon'} role="button" onClick={this.onButtonClick.bind(this, 'right')}>
                    ...
                    <span aria-label=" Justify" class="czi-tooltip-surface" data-tooltip=" Justify" role="tooltip">
                        <span aria-disabled="false" aria-pressed="false" className={this.state.value == 'justify' ? 'czi-custom-button use-icon active' : 'czi-custom-button use-icon'} role="button" onClick={this.onButtonClick.bind(this, 'justify')}>
                ...
                <div class="dropdown-buttons" style={this.state.isAlignment ? { display: "none" } : { display: "block" }}>
                    <span aria-label=" 100%" class="czi-tooltip-surface" data-tooltip=" Left align" role="tooltip">
                        <span aria-disabled="false" aria-pressed="false" className={this.state.value == LINE_SPACING_100 ? 'czi-custom-button use-icon active' : 'czi-custom-button use-icon'} role="button" onClick={this.onButtonClick.bind(this, LINE_SPACING_100)} >
                            <span >Single</span><span>  </span></span></span>
                    <span aria-label=" 115%" class="czi-tooltip-surface" data-tooltip=" Center Align" role="tooltip">
                        <span aria-disabled="false" aria-pressed="false" className={this.state.value == LINE_SPACING_115 ? 'czi-custom-button use-icon active' : 'czi-custom-button use-icon'} role="button" onClick={this.onButtonClick.bind(this, LINE_SPACING_115)} >
                            <span >1.15</span><span>  </span></span></span>
                    <span aria-label=" 150%" class="czi-tooltip-surface" data-tooltip=" Right Align" role="tooltip">
                        <span aria-disabled="false" aria-pressed="false" className={this.state.value == LINE_SPACING_150 ? 'czi-custom-button use-icon active' : 'czi-custom-button use-icon'} role="button" onClick={this.onButtonClick.bind(this, LINE_SPACING_150)} >
                            <span >1.5</span><span>  </span></span></span>
                    <span aria-label=" 232%" class="czi-tooltip-surface" data-tooltip=" Justify" role="tooltip" onClick={this.onButtonClick.bind(this, LINE_SPACING_200)} >
