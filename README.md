...
Now you will find a *modusoperandi-licit-x.y.z.tgz* file in the licit directory.

Add this *.tgz* file to your own angular project and install it using the below command:
```
# At your angular working directory
npm install --save ./modusoperandi-licit-x.y.z.tgz
```
...
ReactDOM.render(React.createElement(Licit, {docID:2}), document.getElementById("root2"));
 ...
 set  *docID* to *""* for disable the collaboration.
...
Please refer *licit\client\index.tsx* for getting more detailed idea on passing properties and fires events.
 ...
 *"styles": [
 "node_modules/licit/dist/styles/styles.css",
]*
OR
in the default global CSS file *src\styles.scss*, add
*@import  "~licit/dist/styles/styles.css"*
...
```
npm install --save "MO-Movia/LICIT-TT"
```
For install a specific commit:
```
npm install --save "MO-Movia/LICIT-TT#3de185eaccdfd745bc567d5358cf3281472d8df8"
```
You may find the latest commit hash at https://github.com/MO-Movia/LICIT-TT/commits/main
